...
from SwinT_Net import swin_base_patch4_window12_384_in22k as create_model
...
class ConfusionMatrix(object):
    ...
    def summary(self):
        ...
        print("the model_classification accuracy is ", acc)
...
if __name__ == '__main__':
    ...
    # 训练权重路径
    parser.add_argument('--weights', type=str, default='./weights/model_classification-19.pth',
