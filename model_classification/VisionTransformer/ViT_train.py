...
def main(args):
    ...
    # 创建存储路径
    path = './weight' + '/' + 'ViT_' + args.model_type
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_classification-name', default='', help='create model_classification name')

    # 预训练权重路径，如果不想载入就设置为空字符
    parser.add_argument('--weights', type=str, default='./pre/vit_base_patch16_224_in21k.pth',
                        help='initial weights path')
    # 是否冻结权重
    parser.add_argument('--freeze-layers', type=bool, default=True)
    parser.add_argument('--device', default='cuda:0', help='device id (i.e. 0 or 0,1 or cpu)')
    parser.add_argument('--model_type', default='base_patch16_224_in21k', help='model_classification in (b,l,h)')
    # 形成参数序列, 输入模型列表
